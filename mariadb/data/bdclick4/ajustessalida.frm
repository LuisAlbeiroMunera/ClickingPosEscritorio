TYPE=VIEW
query=(select `bdclick4`.`bdtraslados`.`Id` AS `Id`,`bdclick4`.`bdtraslados`.`tipo` AS `tipo`,`bdclick4`.`bdtraslados`.`anulada` AS `anulada`,`bdclick4`.`bdtrasladosprod`.`producto` AS `producto`,`bdclick4`.`bdtrasladosprod`.`cantidad` AS `cantidad`,`bdclick4`.`bdtrasladosprod`.`lista` AS `lista`,`bdclick4`.`bdtrasladosprod`.`total` AS `total`,`bdclick4`.`bdtraslados`.`usuario` AS `usuario`,`bdclick4`.`bdtraslados`.`fecha` AS `fecha`,`bdclick4`.`bdtraslados`.`bodega` AS `bodega` from (`bdclick4`.`bdtraslados` left join (`bdclick4`.`bdtrasladosprod` left join `bdclick4`.`bdproductos` on((`bdclick4`.`bdtrasladosprod`.`producto` = `bdclick4`.`bdproductos`.`idSistema`))) on((`bdclick4`.`bdtraslados`.`Id` = `bdclick4`.`bdtrasladosprod`.`traslado`))) where ((`bdclick4`.`bdtraslados`.`tipo` = \'Ajuste Salida\') and (`bdclick4`.`bdtraslados`.`anulada` = 0)))
md5=b29046561834b2956093fd8c686d3220
updatable=0
algorithm=0
definer_user=root
