TYPE=VIEW
query=(select `bdclick4`.`bdtrasladosbodegasprod`.`traslado` AS `traslado`,`bdclick4`.`bdtrasladosbodegasprod`.`producto` AS `producto`,`bdclick4`.`bdtrasladosbodegasprod`.`cantidad` AS `cantidad2`,`bdclick4`.`bdtrasladosbodegas`.`anulada` AS `anulada` from (`bdclick4`.`bdtrasladosbodegas` left join `bdclick4`.`bdtrasladosbodegasprod` on((`bdclick4`.`bdtrasladosbodegas`.`Id` = `bdclick4`.`bdtrasladosbodegasprod`.`traslado`))) group by `bdclick4`.`bdtrasladosbodegasprod`.`traslado`,`bdclick4`.`bdtrasladosbodegasprod`.`producto`,`bdclick4`.`bdtrasladosbodegasprod`.`cantidad`,`bdclick4`.`bdtrasladosbodegas`.`anulada`,`bdclick4`.`bdtrasladosbodegas`.`destino` having ((`bdclick4`.`bdtrasladosbodegas`.`anulada` = 0) and (`bdclick4`.`bdtrasladosbodegas`.`destino` = \'123-55\')))
md5=064c67b6b707a62446752ff4f9cb6b79
updatable=0
algorithm=0
definer_user=root
