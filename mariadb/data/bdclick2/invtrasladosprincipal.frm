TYPE=VIEW
query=(select `bdclick2`.`bdtrasladosprod`.`traslado` AS `traslado`,`bdclick2`.`bdtrasladosprod`.`producto` AS `producto`,`bdclick2`.`bdtrasladosprod`.`cantidad` AS `cantidad`,`bdclick2`.`bdtraslados`.`anulada` AS `anulada` from (`bdclick2`.`bdtraslados` left join `bdclick2`.`bdtrasladosprod` on((`bdclick2`.`bdtraslados`.`Id` = `bdclick2`.`bdtrasladosprod`.`traslado`))) group by `bdclick2`.`bdtrasladosprod`.`traslado`,`bdclick2`.`bdtrasladosprod`.`producto`,`bdclick2`.`bdtrasladosprod`.`cantidad`,`bdclick2`.`bdtraslados`.`anulada`,`bdclick2`.`bdtraslados`.`origen` having ((`bdclick2`.`bdtraslados`.`anulada` = 0) and (`bdclick2`.`bdtraslados`.`origen` = \'123-55\')))
md5=c2f5682a3cd133bf533f614e846eb5a1
updatable=0
algorithm=0
definer_user=root
