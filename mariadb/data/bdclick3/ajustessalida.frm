TYPE=VIEW
query=(select `bdclick3`.`bdtraslados`.`Id` AS `Id`,`bdclick3`.`bdtraslados`.`tipo` AS `tipo`,`bdclick3`.`bdtraslados`.`anulada` AS `anulada`,`bdclick3`.`bdtrasladosprod`.`producto` AS `producto`,`bdclick3`.`bdtrasladosprod`.`cantidad` AS `cantidad`,`bdclick3`.`bdtrasladosprod`.`lista` AS `lista`,`bdclick3`.`bdtrasladosprod`.`total` AS `total`,`bdclick3`.`bdtraslados`.`usuario` AS `usuario`,`bdclick3`.`bdtraslados`.`fecha` AS `fecha`,`bdclick3`.`bdtraslados`.`bodega` AS `bodega` from (`bdclick3`.`bdtraslados` left join (`bdclick3`.`bdtrasladosprod` left join `bdclick3`.`bdproductos` on((`bdclick3`.`bdtrasladosprod`.`producto` = `bdclick3`.`bdproductos`.`idSistema`))) on((`bdclick3`.`bdtraslados`.`Id` = `bdclick3`.`bdtrasladosprod`.`traslado`))) where ((`bdclick3`.`bdtraslados`.`tipo` = \'Ajuste Salida\') and (`bdclick3`.`bdtraslados`.`anulada` = 0)))
md5=e7d041b1f42f73474ea968d3b293101d
updatable=0
algorithm=0
definer_user=root
