TYPE=VIEW
query=select `bdclickppal`.`tipoIdentidad` AS `tipoIdentidad`,`bdclickppal`.`Id` AS `Id`,`bdclickppal`.`codigoEntidadAdministradora` AS `codigoEntidadAdministradora`,`bdclickppal`.`TipoUsuario` AS `TipoUsuario`,`bdclickppal`.`pApellido` AS `pApellido`,`bdclickppal`.`sApellido` AS `sApellido`,`bdclickppal`.`pNombre` AS `pNombre`,`bdclickppal`.`sNombre` AS `sNombre`,`bdclickppal`.`Edad` AS `Edad`,`bdclickppal`.`unidadMedidaEdad` AS `unidadMedidaEdad`,`bdclickppal`.`sexo` AS `sexo`,`bdclickppal`.`codigoDepartamento` AS `codigoDepartamento`,`bdclickppal`.`codigoMunicipio` AS `codigoMunicipio`,`bdclickppal`.`zona` AS `zona`,`bdclickppal`.`facturaNumero` AS `orden`,`bdclickppal`.`estado2` AS `estado2` from `bdclick3`.`bdclickppal`
md5=2c11a96d1ff9e25166467966c275823f
updatable=0
algorithm=0
definer_user=click
