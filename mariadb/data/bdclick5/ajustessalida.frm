TYPE=VIEW
query=(select `bdclick5`.`bdtraslados`.`Id` AS `Id`,`bdclick5`.`bdtraslados`.`tipo` AS `tipo`,`bdclick5`.`bdtraslados`.`anulada` AS `anulada`,`bdclick5`.`bdtrasladosprod`.`producto` AS `producto`,`bdclick5`.`bdtrasladosprod`.`cantidad` AS `cantidad`,`bdclick5`.`bdtrasladosprod`.`lista` AS `lista`,`bdclick5`.`bdtrasladosprod`.`total` AS `total`,`bdclick5`.`bdtraslados`.`usuario` AS `usuario`,`bdclick5`.`bdtraslados`.`fecha` AS `fecha`,`bdclick5`.`bdtraslados`.`bodega` AS `bodega` from (`bdclick5`.`bdtraslados` left join (`bdclick5`.`bdtrasladosprod` left join `bdclick5`.`bdproductos` on((`bdclick5`.`bdtrasladosprod`.`producto` = `bdclick5`.`bdproductos`.`idSistema`))) on((`bdclick5`.`bdtraslados`.`Id` = `bdclick5`.`bdtrasladosprod`.`traslado`))) where ((`bdclick5`.`bdtraslados`.`tipo` = \'Ajuste Salida\') and (`bdclick5`.`bdtraslados`.`anulada` = 0)))
md5=6196ace685f2bbc86bfcf748f20a4c5d
updatable=0
algorithm=0
definer_user=root
