TYPE=VIEW
query=select `bdclick5`.`bdmascotas`.`codigo` AS `codigo`,`bdclick5`.`bdmascotas`.`nombre` AS `nombreMascota`,`bdclick5`.`bdterceros`.`nombre` AS `nombre`,`bdclick5`.`bdterceros`.`telefono` AS `telefono`,`bdclick5`.`bdterceros`.`celular` AS `celular`,`bdclick5`.`bdvacunas`.`nombre` AS `nombreVacuna`,`bdclick5`.`bdvacunacion`.`fecha` AS `fecha`,`bdclick5`.`bdvacunacion`.`proxima` AS `proxima`,`bdclick5`.`bdvacunacion`.`Id` AS `Id`,`bdclick5`.`bdvacunacion`.`gestion` AS `gestion`,`bdclick5`.`bdterceros`.`id` AS `IdTercero`,`bdclick5`.`bdvacunacion`.`fechaGestion` AS `fechaGestion` from ((`bdclick5`.`bdvacunacion` join (`bdclick5`.`bdmascotas` join `bdclick5`.`bdterceros` on((`bdclick5`.`bdmascotas`.`cliente` = `bdclick5`.`bdterceros`.`idSistema`))) on((`bdclick5`.`bdvacunacion`.`mascota` = `bdclick5`.`bdmascotas`.`codigo`))) join `bdclick5`.`bdvacunas` on((`bdclick5`.`bdvacunacion`.`campo` = `bdclick5`.`bdvacunas`.`Id`)))
md5=c63f06c0f5e77cc1e6f10a20bf0a6af2
updatable=1
algorithm=0
definer_user=root
