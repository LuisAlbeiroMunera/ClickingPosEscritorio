TYPE=VIEW
query=select `bdclick5`.`bdtrasladosbodegas`.`Id` AS `Id`,`bdclick5`.`bdtrasladosbodegas`.`origen` AS `origen`,`bdclick5`.`bdtrasladosbodegas`.`destino` AS `destino`,`bdclick5`.`bdtrasladosbodegas`.`fecha` AS `fecha`,`bdclick5`.`bdtrasladosbodegas`.`unidades` AS `unidades`,`bdclick5`.`bdtrasladosbodegas`.`valor` AS `valor`,`bdclick5`.`bdtrasladosbodegas`.`diasPlazo` AS `diasPlazo`,`bdclick5`.`bdtrasladosbodegas`.`estado` AS `estado`,`bdbodegas_1`.`nombre` AS `BodegaDestino`,`bdclick5`.`bdbodegas`.`nombre` AS `BodegaOrigen`,`bdclick5`.`bdtrasladosbodegas`.`anulada` AS `anulada` from ((`bdclick5`.`bdtrasladosbodegas` join `bdclick5`.`bdbodegas` on((`bdclick5`.`bdtrasladosbodegas`.`origen` = `bdclick5`.`bdbodegas`.`codigo`))) join `bdclick5`.`bdbodegas` `bdbodegas_1` on((`bdclick5`.`bdtrasladosbodegas`.`destino` = `bdbodegas_1`.`codigo`)))
md5=5761a67ecb5ee9b05d161fa9d1c0e5eb
updatable=1
algorithm=0
definer_user=root
...
view_body_utf8=select `bdclick5`.`bdtrasladosbodegas`.`Id` AS `Id`,`bdclick5`.`bdtrasladosbodegas`.`origen` AS `origen`,`bdclick5`.`bdtrasladosbodegas`.`destino` AS `destino`,`bdclick5`.`bdtrasladosbodegas`.`fecha` AS `fecha`,`bdclick5`.`bdtrasladosbodegas`.`unidades` AS `unidades`,`bdclick5`.`bdtrasladosbodegas`.`valor` AS `valor`,`bdclick5`.`bdtrasladosbodegas`.`diasPlazo` AS `diasPlazo`,`bdclick5`.`bdtrasladosbodegas`.`estado` AS `estado`,`bdbodegas_1`.`nombre` AS `BodegaDestino`,`bdclick5`.`bdbodegas`.`nombre` AS `BodegaOrigen`,`bdclick5`.`bdtrasladosbodegas`.`anulada` AS `anulada` from ((`bdclick5`.`bdtrasladosbodegas` join `bdclick5`.`bdbodegas` on((`bdclick5`.`bdtrasladosbodegas`.`origen` = `bdclick5`.`bdbodegas`.`codigo`))) join `bdclick5`.`bdbodegas` `bdbodegas_1` on((`bdclick5`.`bdtrasladosbodegas`.`destino` = `bdbodegas_1`.`codigo`)))
