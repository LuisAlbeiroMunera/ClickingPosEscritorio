TYPE=VIEW
query=select `bdclick6`.`bdmascotas`.`codigo` AS `codigo`,`bdclick6`.`bdmascotas`.`nombre` AS `nombreMascota`,`bdclick6`.`bdterceros`.`nombre` AS `nombre`,`bdclick6`.`bdterceros`.`telefono` AS `telefono`,`bdclick6`.`bdterceros`.`celular` AS `celular`,`bdclick6`.`bdvacunas`.`nombre` AS `nombreVacuna`,`bdclick6`.`bdvacunacion`.`fecha` AS `fecha`,`bdclick6`.`bdvacunacion`.`proxima` AS `proxima`,`bdclick6`.`bdvacunacion`.`Id` AS `Id`,`bdclick6`.`bdvacunacion`.`gestion` AS `gestion`,`bdclick6`.`bdterceros`.`id` AS `IdTercero`,`bdclick6`.`bdvacunacion`.`fechaGestion` AS `fechaGestion` from ((`bdclick6`.`bdvacunacion` join (`bdclick6`.`bdmascotas` join `bdclick6`.`bdterceros` on((`bdclick6`.`bdmascotas`.`cliente` = `bdclick6`.`bdterceros`.`idSistema`))) on((`bdclick6`.`bdvacunacion`.`mascota` = `bdclick6`.`bdmascotas`.`codigo`))) join `bdclick6`.`bdvacunas` on((`bdclick6`.`bdvacunacion`.`campo` = `bdclick6`.`bdvacunas`.`Id`)))
md5=ef8cc3a0df4f2c9ce08bc69ff5884087
updatable=1
algorithm=0
definer_user=root
