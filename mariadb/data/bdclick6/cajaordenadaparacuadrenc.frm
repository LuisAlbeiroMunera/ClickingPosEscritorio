TYPE=VIEW
query=(select cast(substr(`bdclick6`.`bdnc`.`Id`,4,100) as signed) AS `ordenId`,`bdclick6`.`bdnc`.`Id` AS `id`,`bdclick6`.`bdnc`.`cuadre` AS `cuadre`,cast(substr(`bdclick6`.`bdnc`.`cuadre`,8,100) as signed) AS `ordenIdCuadre` from `bdclick6`.`bdnc` where ((`bdclick6`.`bdnc`.`cuadre` <> \'\') or (`bdclick6`.`bdnc`.`cuadre` is not null)) order by cast(substr(`bdclick6`.`bdnc`.`Id`,4,100) as signed))
md5=fcb2ac42bea3a45cd62eea22643c6474
updatable=1
algorithm=0
definer_user=root
