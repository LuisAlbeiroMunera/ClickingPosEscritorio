...
public class opcionesDibujo extends javax.swing.JDialog {

    private botones actual;
    Instancias instancias;

    public opcionesDibujo(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        txtNum.requestFocus();
    ...
    public void setActual(botones actual) {
        this.actual = actual;
    }
    ...
    private void initComponents() {
        ...
        txtNum.setFont(new java.awt.Font("Century Gothic", 1, 14)); // NOI18N
    ...
    public void cargar(String num) {
        String dato = num;
        actual.setDato(dato);
        actual.cargarObservacion();
        this.dispose();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(opcionesDibujo.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                opcionesDibujo dialog = new opcionesDibujo(new javax.swing.JFrame(), true);
