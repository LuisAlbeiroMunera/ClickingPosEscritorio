...
public class infMedicamentos extends javax.swing.JInternalFrame {
    ...
    private void initComponents() {
        ...
        jPanel4.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "Medicamentos", javax.swing.border.TitledBorder.CENTER, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Century Gothic", 0, 12))); // NOI18N

        lbNit2.setFont(new java.awt.Font("Century Gothic", 1, 18)); // NOI18N
        lbNit2.setText("Nombre medicamento: *");
        ...
        lbNit5.setFont(new java.awt.Font("Century Gothic", 0, 18)); // NOI18N
        lbNit5.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        lbNit5.setText("Recomendaciones");
        ...
        btnBuscTerceros.setIcon(new javax.swing.ImageIcon(getClass().getResource("/imagenes/buscar.png"))); // NOI18N
        ...
        jPanel1Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(btnBuscTerceros, javax.swing.GroupLayout.PREFERRED_SIZE, 130, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    private void txtNombreKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txtNombreKeyReleased
        if (evt.getKeyCode() == KeyEvent.VK_ENTER) {
            cargarCliente(txtNombre.getText());
        }
...
//            try {
            Object[] vector = {"", txtNombre.getText(), txtRecomendacion.getText(), instancias.getUsuario()};

            ndMedicamentos nodo = metodos.llenarMedicamentos(vector);

            if (!instancias.getSql().agregarMedicamento(nodo)) {
                metodos.msgError(this, "Hubo un problema al guardar el medicamento");
                return;
            }
            txtNombre.getText();
            metodos.msgExito(this, "Medicamento registrado con éxito");

            btnNuevoActionPerformed(evt);
//            } catch (Exception e) {
//                metodos.msgError(this, "Hubo un problema al guardar la medicamento");
//            }
        }
    ...
    private void btnActualizarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnActualizarActionPerformed
        ...
        if (metodos.msgPregunta(this, "¿Desea continuar?") == 0) {
            ...
            Object[] vector = {txtCodigo.getText(), txtNombre.getText(), txtRecomendacion.getText(), instancias.getUsuario(),};

            ndMedicamentos nodo = metodos.llenarMedicamentos(vector);

            if (!instancias.getSql().modificarMedicamento(nodo)) {
                metodos.msgError(this, "Hubo un problema al modificar el medicamento");
                return;
            }

            metodos.msgExito(this, "Medicamento modificado con éxito");
    ...
    public void cargarCliente(String nit) {
        ...
        if (nodo.getId() != null) {
            ...
            txtRecomendacion.setText(nodo.getRecomendacion());
            txtRecomendacion.requestFocus();
