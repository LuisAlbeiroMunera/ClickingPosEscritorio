...
public class infRepProveedores extends javax.swing.JInternalFrame {
    ...
    private void txtClienteKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txtClienteKeyReleased
        if (evt.getKeyCode() == KeyEvent.VK_ENTER) {
            cargarProveedor(txtCliente.getText());
        }
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        if (metodos.msgPregunta(this, "¿Desea continuar?") == 0) {
            ...
            if (btnExcel.isSelected()) {
                instancias.setRutaAguardar(metodos.obtenerRuta(null, "Reporte de proveedores"));
                tipo = "xls";
            }

            instancias.getReporte().ver_RepProveedores(condicion(), tipo);
        }
    ...
    private String condicion() {
        ...
        if ((chActivos.isSelected() && chInactivos.isSelected()) || (!chActivos.isSelected() && !chInactivos.isSelected())) {
            sql = "where tipoTercero = 'PROVEEDOR' ";
        } else if (chActivos.isSelected()) {
            sql = "where activo=false AND tipoTercero = 'PROVEEDOR' ";
        } else {
            sql = "where activo=true AND tipoTercero = 'PROVEEDOR' ";
        }
        ...
        Logs.log("Consulta Reporte Proveedores: " + sql);
        return sql;
    }
