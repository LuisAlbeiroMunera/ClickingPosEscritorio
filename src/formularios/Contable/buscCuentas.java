...
public class buscCuentas extends javax.swing.JDialog {
    ...
    public buscCuentas(java.awt.Frame parent, boolean modal, Boolean soloAfectables, String codigo, int fila, String lugar) {
        super(parent, modal);
        initComponents();
        ...
        cod = codigo;
        this.buscarInactivos = soloAfectables;
        this.fila = fila;
        this.lugar = lugar;
    ...
    private void initComponents() {
        ...
        btnEste1.setBackground(new java.awt.Color(241, 148, 138));
        btnEste1.setFont(new java.awt.Font("Century Gothic", 0, 13)); // NOI18N
        btnEste1.setText("SIN REGISTRO");
        ...
        jPanel1Layout.setHorizontalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel1Layout.createSequentialGroup()
                ...
                .addComponent(btnEste, javax.swing.GroupLayout.PREFERRED_SIZE, 131, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(btnEste1, javax.swing.GroupLayout.PREFERRED_SIZE, 140, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addContainerGap(javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
        );
    ...
    private void btnEsteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnEsteActionPerformed
        if (tblRegistros.getSelectedRow() >= 0) {
            if (lugar.equals("Comprobantes")) {
                instancias.getComprobantes().cargarCuenta(fila, tblRegistros.getValueAt(tblRegistros.getSelectedRow(), 0).toString(),
                        tblRegistros.getValueAt(tblRegistros.getSelectedRow(), 1).toString(),
                        tblRegistros.getValueAt(tblRegistros.getSelectedRow(), 2).toString());
            } else if (lugar.equals("Ambitos")) {
                instancias.getBuscAmbitos().cargarCuenta(fila, tblRegistros.getValueAt(tblRegistros.getSelectedRow(), 1).toString());
            } else if (lugar.equals("Ambitos1")) {
                instancias.getBuscAmbitos().cargarCuenta1(tblRegistros.getValueAt(tblRegistros.getSelectedRow(), 0).toString(), tblRegistros.getValueAt(tblRegistros.getSelectedRow(), 1).toString());
            } else {
    ...
    private void btnEste1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnEste1ActionPerformed
        if (tblRegistros.getSelectedRow() >= 0) {
            if (lugar.equals("Comprobantes")) {
                instancias.getComprobantes().cargarCuenta(fila, "", "", "");
            } else if (lugar.equals("Ambitos")) {
                instancias.getBuscAmbitos().cargarCuenta(fila, "");
            } else if (lugar.equals("Ambitos1")) {
                instancias.getBuscAmbitos().cargarCuenta1("", "");
            }
        }
    ...
    public void noEncontrado(String codigo) {
        ...
        if (!buscarInactivos) {
            if (cod.equals("")) {
                consulta = " Where afectable = false ";
            } else {
                consulta = " Where afectable = false and codPUC = '" + cod + "' ";
            }
        } else {
            if (cod.equals("")) {
                consulta = " Where afectable = true ";
            } else {
                consulta = " Where afectable = true and codPUC = '" + cod + "' ";
            }
        }

        Logs.log("consulta " + consulta);
        tblRegistros.setModel(instancias.getSql().getRegistrosCuentas1(consulta));
        ...
        if (tblRegistros.getColumnModel().getColumnCount() > 0) {
            ...
            tblRegistros.getColumnModel().getColumn(1).setMinWidth(130);
            tblRegistros.getColumnModel().getColumn(1).setPreferredWidth(130);
            ...
            tblRegistros.getColumnModel().getColumn(4).setMinWidth(80);
            tblRegistros.getColumnModel().getColumn(4).setPreferredWidth(80);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(buscCuentas.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                buscCuentas dialog = new buscCuentas(new javax.swing.JFrame(), true, false, "", 0, "");
