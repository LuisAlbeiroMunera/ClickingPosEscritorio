...
public class msgIngresar extends javax.swing.JDialog {

    metodosGenerales metodos = new metodosGenerales();
    String respuesta = "";

    public msgIngresar(java.awt.Frame parent, boolean modal, String mensaje) {
        super(parent, modal);
        initComponents();
    ...
    private void initComponents() {
        ...
        txtTexto.setFont(new java.awt.Font("Century Gothic", 0, 18)); // NOI18N
...
//        this.dispose();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(msgIngresar.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                msgIngresar dialog = new msgIngresar(new javax.swing.JFrame(), true, "");
