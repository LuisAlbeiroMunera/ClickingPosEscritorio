...
public class convertirNumeroALetras {
    ...
    public String Convertir(String numero) {
        System.err.println("clases.convertirNumeroALetras.Convertir()"+"Luis munera cardenasssssssssssssssssssssssssss");
        Logs.log("Luis Albeiro");
    String literal = "";
    ...
    if (Pattern.matches("\\d{1,12},\\d{1,2}", numero)) {
        ...
        if (mayusculas) {
            ...
            return (literal + parte_decimal + " pesos");
        }
...
//    
    public String Convertir(String numero,String moneda) {
          Logs.log("Luis Albeiro PPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPP");
        boolean mayusculas = true;
        String literal = "";
        String parte_decimal;
        //si el numero utiliza (.) en lugar de (,) -> se reemplaza
